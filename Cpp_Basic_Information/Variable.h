...
namespace VARIABLE_COMMENTS
{
    ...
    public:
        ...
        void ShowData() const;
        void SetData(int number1, int number2, int number3); // Removed unnecessary `const` for parameters passed by value  
...
/*
Summary of Good and Bad Practices for Variables in C++ Classes
Good Practices
